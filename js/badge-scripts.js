...
badges = {
	...
	storyteller : {
		name : 'Storyteller',
		description : 'If you like reading and writing, then you will enjoy earning this badge. Let your imagination run wild and learn new ways to tell stories.',
		...
		tasks : {
			task1 : {
					id : 'books',
					title : `Read 3 Books of Your Choice`,
					mainPhoto : '',
					mainPhotoAlt : ``,
					instructions : `Reading is a great way to inspire your writing. Try to read different genres and styles to find fresh ideas. Reading books can give you new ideas that you might like to incorporate into your own writing.<br><br>

						If you are not sure what to read, you can visit your local library and ask a librarian for a recommendation. <br><br>
						Bea's loves funny stories. Here are some of her favorites to give you some inspiration:
						`,
					photo  : `images/tasks/storyteller/recommended-books.jpeg`,
					photoAlt : `bea tv book recommendations`,
					photoCredit : `<span>Photo by <a href="https://unsplash.com/@anniespratt?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Annie Spratt</a> on <a href="/s/photos/reading?utm_source=unsplash&amp;utm_medium=referral&amp;utm_content=creditCopyText">Unsplash</a></span>`,
					task : `Task 1: Read 3 books of Your Choice. Write Down Some Things That You Like About the Story and Some Things That You Would Change About The Story if You Had Written It`,
					ywn : ``,
					youTube : ``
				},
			task2 : {
					...
					mainPhoto : '',
					mainPhotoAlt : ``,
					instructions : `MadLibs are a word game where one player prompts the other player  to fill in blanks in a story. The other party doesn't know what the story is, so the results can often be pretty hilarious! The game was invented in 1958 in the United States. There are various different MabLibs books available and you can find lots of them online.<br><br>
						<img src="images/tasks/storyteller/family-writing.jpg" alt="mother and daughter writing"><br><br>
						MadLibs are a great way to make up funny, crazy stories that you can use as inspiration to add silly elements to your own stories.`,
					photo  : `images/tasks/storyteller/madLibs.png`,
					photoAlt : `Madlibs example`,
					photoCredit : ``,
					task : `Task 2: Play Madlibs to Get Ideas for Your Stories`,
					ywn : [`<a href="http://www.madlibs.com/content/uploads/2016/04/VacationFun_ML_2009_pg15.pdf" target="_blank"> Click Here to Download a Madlib Sheet from Madlibs.com</a>`, `<a href="https://www.woojr.com/summer-mad-libs/" target="_blank">Click here for Lots of Summer MadLib Printables from WooJr.com</a>`, `<a href="http://www.madlibs.com/apps/" target="_blank">Click here to get the MadLibs app</a>`],
					youTube : ``
			},
			task3 : {
					id : 'interview',
					...
					mainPhoto : ``,
					mainPhotoAlt : ``,
					instructions : `Interviewing family members is a great way to find out new stories that you may not know and capture your family's history. Are there any mysteries in your family? Do you have family members who live far away or even in different countries that have lives that are very different to yours? Do you have much older relatives that you could interview, like grandparents, or even great-grandparents, who had a very different childhood to yours?<br><br><img src="images/tasks/storyteller/vintage_family_in_water.jpg" alt="vintage family in a lake"><br><br>Start by making a list of family members that you want to interview. Think about people who would have interesting stories you could ask them about. Ask these family members if you can interview them. You could call them, video call them or go visit them, if they agree to have you interview them.<br><br>Make a list of questions that you can ask them to find out their stories. Try to make the questions open-ended, such as, 'What was your childhood like?, or 'What is your favorite memory from high school?'. If you find a particular story interesting, don't be afraid to deviate from your questions and ask questions to get more details about the stories you are being told.<br><br>Here are some interview questions to get you started, but feel free to make your own list of questions.
						<div id="interview">
						<h3>Possible Interview Questions</h3>
						<ul>
							<li>Where did you grow up and what was it like?</li>
							<li>Do you know any stories about ancestors immigrating to America? Where did they come from?</li>
							<li>Do you have any old photos you can show me?</li>
							<li>Who were your heroes as a child? Why?</li>
							<li>Who were you closest to in your family as a child? What were your favorite things to do with this person?</li>
							<li>What was your favorite subject in school?</li>
							<li>How did you meet your spouse?</li>
							<li>What was your wedding and reception like?</li>
							<li>What was your first job?</li>
							<li>Tell me a funny story about your family.</li>
							<li>What was your favorite vacation? Why?</li>
							<li>How was your childhood different to mine?</li>
							<li>Do you remember any of the songs sung or jokes told by family members? Sing me a song. Tell me a joke.</li>
							<li>Did you have a nickname when you were growing up? If so, what was it and why were called that?</li>
							<li>Was there a chore you really hated doing as a child?</li>
							<li>What kinds of books did you like to read as a child?</li>
							<li>What did you wear to school? Describe it.</li>
							<li>Who was the oldest person you remember as a child?</li>
							<li>Name a good friend you have known the longest. How many years have you been friends?</li>
							<li>Do you remember any advice or comments that had a big impact on how you lived your life?</li>
							<li>What pets have you had? Do you have a favorite story about a pet?</li>
							<li>What traditions did your family have for celebrating birthdays, anniversaries or holidays?</li>
						</ul></div>`,
					photo  : `images/tasks/storyteller/interview.jpg`,
					photoAlt : `two people talking`,
					photoCredit : ``,
					task : `Task 3: Interview One or More Family Members, then Pick Your Favorite Story from the Interview(s) and Write Your Own Story About it`,
					ywn : ['A List of Interview Questions', 'Something to Record the Interview: A Camera, A Voice Recorder or Just a Pencil and Paper Works too!'],
					youTube : `SWRYIAfojqk`
				},
			task4 : {
					id : 'coop',
					title : `Cooperative Partner Stories`,
					mainPhoto : '',
					mainPhotoAlt : ``,
					instructions : `It can be fun to write stories on your own, but have you ever written a story with someone else? Cooperative story writing makes writing more interactive and really helps to stretch your imagination as you have to adjust to what was written by the other person, rather than just writing what you had already imagined for the story.<br><br>There are a few different ways to write a cooperative story. Here are a few ways you can try this, depending on how long of a story you plan to write:
						<ul id="writingGames">
						<li><strong>The Dice Game (from the video at the bottom of this task)</strong><br> For this game, you will need a friend, a dice, a different color marker for each of you and some paper.<br>Each person will roll the dice in turn and write the number of words shown on the dice on the paper for their turn. </li>
						<li><strong>Pass The Paper Writing Game</strong><br>For this game, you will need a friend, some paper and a different color marker each.<br>Simply take it in turns to write a sentence of the story</li>
						<li><strong>Structured Swapped Paragraph Writing Game</strong><br>For this game, you will need a friend, a different color marker for each person and some paper.<br>This game is good for writing longer, more structured stories. Firstly, you should both sit down together and decided on a few parts of the story. <ul id="structured">
						<li>You should decide on a few characters from the story. Try to add in some details about them, such as personality traits and unique features.</li>
						<li>Next, think about a setting for your story. Maybe a few locations or a town name.</li>
						<li>You should also think of a problem and a solution that you want to write about for this story.</li>
						<li>Finally, you should both agree on a title for the story.</li>
						</ul><br>With all these details figured out, you will have a good basic structure for your story. The first person will start the story and write the first paragraph. Pass the paper to the other person and they will write the next paragraph and so on. Switch back every paragraph. This is a good game to play with a penpal or over a longer period of time!</li>
						</ul>`,
					photo  : `images/tasks/storyteller/writing.jpg`,
					photoAlt : `girl writing on a sun lounger`,
					photoCredit : ``,
			...
			task5 : {
					...
					mainPhoto : '',
					mainPhotoAlt : ``,
					instructions : `By this point, you should hopefully have lots of different ideas for stories. In this task, you are going to make a book to hold your story.<br><br>
						<img src="images/tasks/storyteller/black-and-red-typewriter.jpg" alt="typewriter saying stories matter">
					<br><br> The video below from <a href="https://www.youtube.com/channel/UCGbxOeCBuGSsKvt4g9lEv3A" target="_blank">Sea Lemon</a> shows you how to bind a book with a simple stitch. If you have trouble with this, you can always ask an adult for help (especially when you are making holes with the awl - please be careful!).Try not to put too many pages in your book.<br><br>
						You can also try laminating the cover page for a more durable cover. <br><br><a href="https://www.youtube.com/watch?v=aWHkY5jOoqM&list=PL2F704E01F80BA1E9" target="_blank">Sea Lemon's YouTube Channel</a> also has lots of other book binding tutorials if you want to try a different style to bind your book.
						<br><br>Once you have created your book, you can write your story in your new book. Feel free to add illustrations as you go.`,
					photo  : `images/tasks/storyteller/pile-of-books.jpg`,
					photoAlt : `pile of books`,
					photoCredit : ``,
					task : `Task 5: Create a Book with One or More Stories and Bind It Together`,
					ywn : ['Paper for the Cover and Pages', 'Thread', 'Awl and Binder Clips', 'Needle', 'Scissors', 'Something Heavy, like a Large Book or Weight'],
					youTube : `aWHkY5jOoqM`
			}
		}
	}
